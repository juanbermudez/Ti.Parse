...
// in simulator we redefine to format for TiParse Developer console
...
{\
	NSString * exceptionName = [@"org.tiparse." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.tiparse";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UITiParseNativeItemNone = -1, 
	UITiParseNativeItemSpinner = -2,
	UITiParseNativeItemProgressBar = -3,
	
	UITiParseNativeItemSlider = -4,
	UITiParseNativeItemSwitch = -5,
	UITiParseNativeItemMultiButton = -6,
	UITiParseNativeItemSegmented = -7,
	
	UITiParseNativeItemTextView = -8,
	UITiParseNativeItemTextField = -9,
	UITiParseNativeItemSearchBar = -10,
	
	UITiParseNativeItemPicker = -11,
	UITiParseNativeItemDatePicker = -12,
	
	UITiParseNativeItemInfoLight = -13,
	UITiParseNativeItemInfoDark = -14,
	
	UITiParseNativeItemDisclosure = -15,
	
	UITiParseNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all TiParse instances of
