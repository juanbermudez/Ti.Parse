...
/**
 The base class for all TiParse modules
 */
...
/**
 TiParse Platform calls this method on startup.
 */
-(void)startup;

/**
 TiParse Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 TiParse Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 TiParse Platform calls this method on resume.
 @param sender The sender of the event.
 */
