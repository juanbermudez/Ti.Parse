 ...
 * Copyright (c) 2009-2011 by TiParse, Inc. All Rights Reserved.
...
//@interface TiParseObject : NSObject
//@end

@interface TiParseObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TiParseObject class]])
		{
			for (NSString *key in [[(TiParseObject*)o modules] allKeys])
			{
